	...
	<div class="grid_24">
		...
		<div id="breadcrumb">
			...
			<ul class="left">
				...
				<li class="icon point_right"><a href="__APP__/UserInfo/index">个人信息</a></li>
			</ul>
			<!-- Breadcrumb: End -->
...
<div class="grid_18">
	...
	<div class="box_content padding" >
		...
		<input name="mobile" type="text" style="color: #a3abad;background-color:#fcfcfc;" value="<?php echo ($user['mobile']); ?>"/>
		</div>
		<div class='field'>
		...
		<input name="email" type="text" style="color: #a3abad;background-color:#fcfcfc;" value="<?php echo ($user['email']); ?>"/>
		</div>
		<div class='field'>
		<label class='left'>办公电话：</label>
		<input name="tel" type="text" style="color: #a3abad;background-color:#fcfcfc;" value="<?php echo ($user['tel']); ?>"/>
		</div>
		<div class='field'>
		<label class='left'>办公地址：</label>
		<input name="address" type="text" style="color: #a3abad;background-color:#fcfcfc;" value="<?php echo ($user['address']); ?>"/>
		</div>
...
$('#submit').click(function(){
	if($.trim($('input[name="mobile"]').val())=="" || $.trim($('input[name="mobile"]').val())==null){
			alert('手机号不为空，请重新填写');
			return;
		}
	$.post(
			"__APP__/UserInfo/updateUser",
			{'mobile':$('input[name="mobile"]').val(),'email':$('input[name="email"]').val(),'tel':$('input[name="tel"]').val(),'address':$('input[name="address"]').val()},
			function(data){
					window.location.reload(true);
				}
			)
