				...
				<table class="sorting">
					...
					<tbody>
						...
						<?php if(is_array($info["content"])): $i = 0; $__LIST__ = $info["content"];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$content): $mod = ($i % 2 );++$i;?><tr>
								...
								<td class="align_left"><a href="__APP__/InterInfo/lookup/eid/<?php echo ($content["eid"]); ?>"><?php echo ($content["title"]); ?></a></td>
								...
								<td class="align_left tools center">
									<a href="__APP__/InterInfo/look/eid/<?php echo ($content["eid"]); ?>" rel='facebox' class="view tip" title="查看">查看</a>
									<a href="__APP__/InterInfo/edit/eid/<?php echo ($content["eid"]); ?>" class="edit tip" title="编辑">编辑</a>
