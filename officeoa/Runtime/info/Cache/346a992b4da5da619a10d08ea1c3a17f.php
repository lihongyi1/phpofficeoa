			...
			<ul id="navigation" class="dropdown">
				...
				<li class="topnav">
					...
					<ul class="subnav">
			            ...
			            <li><a href="tabs.html" class="icon pages">公文通知</a></li>
	...
	<div class="box_content">
		...
		<!-- Vertical Menu: Start -->
			<ul class="menu">
				...
				<?php if(MODULE_NAME == Working): ?><li><a href="__ROOT__/personal/index.php?s=/Working/index" class='active'><span class="icon pages"></span>公文通知</a><?php else: ?><li><a href="__ROOT__/personal/index.php?s=/Working/index"><span class="icon pages"></span>公文通知</a><?php endif; ?>
...
<div class="grid_18">
	...
	<div class="box_top padding">
		...
		<li>
		<a class="active" href="javascript:void(0)">修改</a>
		</li>
		</ul>
	</div>
	<!-- Box Header: End -->
	...
	<div class="box_content padding">
		<div class="field">
		<label class="left" >通知标题:</label>
		<input type="text" id="title" value="<?php echo ($info["title"]); ?>"/>
		</div>
		<input type="hidden" value="<?php echo ($info['eid']); ?>" id="eid"/>
		<div class="field">
		<label >通知内容:</label>
		<?php echo W('Editor',array('content'=>$info['content']));?>
		</div>
...
$(function(){
	$('#submit').click(function(){
		...
		$.post(
				"__APP__/InterInfo/doedit",
				{'eid':$('#eid').val(),'title':title,'content':content},
				function(data){
					if(data=='error'){
						alert('操作失败，请重试');
						}else{
							alert('操作成功');
							window.location.href='__APP__/InterInfo/index';
							}
