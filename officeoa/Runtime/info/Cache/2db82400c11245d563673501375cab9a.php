...
<div class="grid_6">
	...
	<div class="box_content">
		...
		<!-- Vertical Menu: Start -->
			<ul class="menu">
				<?php if(MODULE_NAME == Info): ?><li><a href="__ROOT__/info/index.php?s=/Info/electronic" class='active'><span class="icon pages"></span>电子公告</a><?php else: ?><li><a href="__ROOT__/info/index.php?s=/Info/electronic"><span class="icon pages"></span>电子公告</a><?php endif; ?>
